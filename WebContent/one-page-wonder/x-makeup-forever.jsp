...
<head>
    ...
    <!-- Theme CSS -->
    <link href="${pageContext.request.contextPath}/assets/css/ff.css" rel="stylesheet">
...
<body>
    ...
    <!-- Navigation -->
    <nav class="navbar fixed-top navbar-toggleable-md navbar-light" id="mainNavOthers">
        <button class="navbar-toggler navbar-toggler-right" type="button" 
        		data-toggle="collapse" data-target="#navbarExample" aria-controls="navbarExample" 
    ...
    <!-- Theme JavaScript -->
    <script src="${pageContext.request.contextPath}/assets/js/clean-blog.min.js"></script>
