...
<body>
    ...
    <header class="intro-header" style="background-image: url('${pageContext.request.contextPath}/assets-page/img/primary-travels.jpg')">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-6 portfolio-box">
                    ...
                    <div class="portfolio-box-caption">
						<div class="portfolio-box-caption-content">
							...
							<div class="project-name">Little Office Girl in Japan</div>
						</div>
					</div>
                </div>
                <div class="col-lg-4 col-sm-6 portfolio-box">
