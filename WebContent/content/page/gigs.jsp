        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    	...
                    	Slowly, though they're a few, these gigs kind of helped me build the basics 
                    	that a Makeup Artist should have.
                    	</p>
                    ...
                    <img class="img-responsive" 
                   		src="${pageContext.request.contextPath}/assets-page/img/gigs/qos-setup.jpg" 
                    		alt="Joane Denise's Makeup Gigs">
                    	<span class="caption text-muted">My humble setup</span>
                    ...
                    <img class="img-responsive" 
                   		src="${pageContext.request.contextPath}/assets-page/img/gigs/qos-from-afar.jpg" 
                    		alt="Joane Denise's Makeup Gigs">
                    	<span class="caption text-muted">My girls working it.</span>
                    <p>The sweetest thing that could ever happen to me during that moment is that one of my girls, 
                    Malia took home the crown that night. </p>
                    <img class="img-responsive" 
                   		src="${pageContext.request.contextPath}/assets-page/img/gigs/qos-closest.jpg" 
                    		alt="Joane Denise's Makeup Gigs">
                    	<span class="caption text-muted">The closest shot I could get from Malia.</span>
                    <img class="img-responsive" 
                   		src="${pageContext.request.contextPath}/assets-page/img/gigs/qos-court.jpg" 
                    		alt="Joane Denise's Makeup Gigs">
                    	<span class="caption text-muted">The Queen and her court</span>
                    ...
                    <img class="img-responsive" 
                   		src="${pageContext.request.contextPath}/assets-page/img/gigs/bevello-frickspicks.jpg" 
                    		alt="Joane Denise's Makeup Gigs">
                    	<span class="caption text-muted">@frickspicks (realgoldengirl.com) and Dom, our Hairstylist</span>
                    <img class="img-responsive" 
                    ...
                    <p>Here, I became part of the Glam Squad for Chloe Rose Boutique's Seasonal Catalog.</p>
                    ...
                    the final photos.</p>
                    	...
                    	<p>My main takeaway from this experience is.. I needed a Makeup Chair! I don't want 
                    	to hurt my back with all the bending. </p>
