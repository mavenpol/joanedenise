...
<body>
    ...
    <header class="intro-header" style="background-image: url('${pageContext.request.contextPath}/assets-page/img/primary-beauty.jpg')">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="site-heading">
                        <h1>Makeup & Beauty</h1>
                        <hr class="small">
                        <span class="subheading">by Joane Denise</span>
                    </div>
                </div>
            </div>
        </div>
